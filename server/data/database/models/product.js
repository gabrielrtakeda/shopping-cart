...
addProduct(1, 10, { default: 179.9 }, 'Brouwerij De Sint-Sixtusabdij van Westvleteren Westvleteren 12 (XII)', ['ABV: 10.2 percent', 'Westvleteren, Belgium'], 'https://thumbor.thedailymeal.com/a0buBt7LF_HDOiJbVnjoZNo6X1k=/840x565/https://www.thedailymeal.com/sites/default/files/2018/02/13/2_Brouweij%20De%20Sint_Slide_edit_0.jpg', 'A true Trappist beer, brewed by Trappist monks on the grounds of the Saint Sixtus Abbey, this Belgian quad is a rich chestnut brown color with a nose of dark fruit and brown sugar. Complex and spicy, this brew is full of lively carbonation. What makes this beer so special is not only its taste but its rarity. Procuring a bottle is notoriously difficult; the monks are only allowed to make enough beer each month to support themselves and no more.');
addProduct(0, 15, { default: 129.90, sale: 99.90  }, 'The Alchemist Heady Topper', ['ABV: 8 percent', 'Waterbury, Vermont, U.S.'], 'http://4.bp.blogspot.com/-0M76sN2lgpo/VAM9NnL5a2I/AAAAAAAABYo/S5nx0fkLSsM/s1600/DSC05353.JPG', 'The double IPA is a divisive beer type; oftentimes, the battle for getting the dankest, hoppiest brew overrides any hint of complementary flavors. This is not the case for The Alchemist’s flagship brew, Heady Topper. Incredibly difficult to procure (unless you live within 20 miles of the brewery), this Vermont double IPA is beloved by beer enthusiasts around the world thanks to its intoxicating aroma and pure hop flavor that comes in waves of oranges, pine, and spice.');
addProduct(0, 25, { default: 129.90, sale: 79.90  }, 'Russian River Pliny the Younger', ['ABV: 10.25 percent', 'Santa Rosa, California, U.S.'], 'https://c1.staticflickr.com/3/2786/4365953661_ff0f2ec418_b.jpg', 'This true triple IPA is extremely difficult, expensive, and time-consuming to make. Thus, it’s available in pub draft only and is released at the brewery on the first Friday in February for two weeks only. It has a lot of hype, but it’s well deserved. There have been many imitators since Pliny the Younger first debuted in 2005, but no other triple IPA has bested the balanced, medium bitterness and a beautiful copper color of this brew.');
